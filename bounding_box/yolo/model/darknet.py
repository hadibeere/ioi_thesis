...
import numpy as np
from yolo.util.util import convert2cpu as cpu
from yolo.util.util import predict_transform
...
def create_modules(blocks):
    ...
    for x in blocks:
        ...
        # Yolo is the detection layer
            ...
            anchor_num.append(len(mask))

            anchors = x["anchors"].split(",")
            anchors = [int(a) for a in anchors]
            anchors_total = [[anchors[i], anchors[i+1]] for i in range(0, len(anchors),2)]
    ...
    net_info['anchors'] = anchors_total
    net_info['num_anchors'] = anchor_num
